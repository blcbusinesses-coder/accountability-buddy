...
export default function SubmitScreen() {
  ...
  const ModeTab = ({ m, icon, label }: { m: SubmissionMode; icon: any; label: string }) => {
    ...
    return (
      <TouchableOpacity
        style={[styles.modeTab, active && { backgroundColor: theme.primaryMuted }]}
      ...
      >
        ...
        <Text style={[styles.modeTabText, { color: active ? theme.primary : theme.textMuted }]}>{label}</Text>
      </TouchableOpacity>
    );
  };
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top']}>
      <View style={[styles.header, { borderBottomColor: theme.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.textPrimary }]}>Submit Proof</Text>
        <View style={{ width: 36 }} />
      </View>
                ...
                <View style={[styles.photoPlaceholder, { backgroundColor: theme.surface, borderColor: theme.border }]}>
                  ...
                  <View style={styles.photoActions}>
                    ...
                    >
                      ...
                      <Text style={[styles.photoActionText, { color: theme.primary }]}>Camera</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={[styles.photoActionBtn, { backgroundColor: theme.primaryMuted, borderColor: theme.border }]}
                    ...
                    >
                      ...
                      <Text style={[styles.photoActionText, { color: theme.primary }]}>Library</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              )}
...
const styles = StyleSheet.create({
  ...
  doneBtnText: { color: '#000', fontWeight: '700', fontSize: 13 },
  photoPlaceholder: {
  ...
  photoActionText: { fontWeight: '600', fontSize: 14 },
  ...
  audioStatus: { fontSize: 14, fontWeight: '500' },
  audioBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 10,
    paddingHorizontal: 24, paddingVertical: 13, borderRadius: 14,
  },
  audioBtnText: { color: '#000', fontWeight: '700', fontSize: 15 },
